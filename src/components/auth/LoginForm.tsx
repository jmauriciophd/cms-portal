    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-center">Portal CMS</CardTitle>
          <CardDescription className="text-center">
            {showOTP ? 'Autenticação de Dois Fatores' : 'Sistema de Gerenciamento de Conteúdo'}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {!showOTP ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-xs text-center text-gray-500 mt-4 space-y-1">
                ...
                <p>Editor: editor@portal.com / editor123</p>
              </div>
            </form>
          ) : (
            <div className="space-y-4">
              <div className="space-y-2">
                <Label className="text-center block">Digite o código de 6 dígitos</Label>
                <p className="text-xs text-center text-gray-500 mb-4">
                  Use qualquer combinação de 6 números para demonstração
                </p>
